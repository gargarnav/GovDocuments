            ...
            <div className="content-container">
                <div style={{ maxWidth: '800px', margin: '0 auto', color: '#334155', lineHeight: '1.7' }}>
                    ...
                    <p style={{ marginBottom: '1.5rem' }}>
                        ...
                        <Link to="/?search=Passport" className="text-link" onClick={(e) => handleLinkClick('Passport', e)}>Passport</Link> or updating your
                        <Link to="/?search=Aadhaar" className="text-link" onClick={(e) => handleLinkClick('Aadhaar', e)}>Aadhaar card</Link> details, having the correct
                    ...
                    <p style={{ marginBottom: '1.5rem' }}>
                        ...
                        For instance, when applying for a <Link to="/?search=PAN" className="text-link" onClick={(e) => handleLinkClick('PAN', e)}>PAN Card</Link>,
                        it is mandatory to ensure that your demographic details match exactly with your Aadhaar data. Similarly, obtaining a
                        <Link to="/?search=Driving" className="text-link" onClick={(e) => handleLinkClick('Driving', e)}>Driving License</Link> requires a specific set of
                    ...
                    <p style={{ marginBottom: '1.5rem' }}>
                        Beyond identity cards, life events require specific documentation. A <Link to="/?search=Birth" className="text-link" onClick={(e) => handleLinkClick('Birth', e)}>Birth Certificate</Link>
                        ...
                        <Link to="/?search=Income" className="text-link" onClick={(e) => handleLinkClick('Income', e)}>Income Certificate</Link> is often needed for
                    ...
                    <p>
                        ...
                        best way to avoid delays. From understanding the difference between a <Link to="/?search=Voter" className="text-link" onClick={(e) => handleLinkClick('Voter', e)}>Voter ID</Link>
